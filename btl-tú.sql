IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'QuanLyBenhAnDienTu')
BEGIN
    CREATE DATABASE QuanLyBenhAnDienTu;
END
GO
...
CREATE TABLE Nguoi (
    MaNguoi INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE NguoiGiamHo (
    MaNguoiGiamHo INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE LichSuKham (
    MaLichSuKham INT PRIMARY KEY IDENTITY(1,1),
    MaBenhNhan INT NOT NULL,
